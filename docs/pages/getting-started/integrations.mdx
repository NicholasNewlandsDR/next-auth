...
| `@digital-realty/auth-core`           | Released (experimental)                                                          |
...
In case you are a maintainer of a package that uses `@digital-realty/auth-core`, feel free to [reach out to
Balázs](https://twitter.com/balazsorban44) or [info@authjs.dev](mailto:info@authjs.dev), if you want to collaborate on making it an official package, maintained in our repository. If you are interested in bringing `@digital-realty/auth-core` support to your favorite framework, we would love to hear from you!
