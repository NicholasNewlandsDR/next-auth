...
Based on NextAuth.js, Balázs released [Auth.js (`@digital-realty/auth-core`)](https://twitter.com/balazsorban44/status/1603082914362986496), a runtime/framework independent core library that is the base of
